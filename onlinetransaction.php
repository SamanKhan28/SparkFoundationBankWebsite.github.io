...
if (isset($_POST['done'])) {
    ...
    $Reciver = $_POST['To'];
    $ReciverAccont = $_POST['accountNo'];
    $From = $_POST['from'];
    $Account = $_POST['accountnum'];
    $Amount = $_POST['amount'];
    $q = "INSERT INTO `history`(`ReciverName`, `Receiver_AccountNo`, `SenderName`, `Sender_AccountNo`, `Amount`) VALUES ('$Reciver', '$ReciverAccont','$From',' $Account',' $Amount')";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form method="post" class="main_form" >
                        <div class="row">
                            <div class="col-md-6 ">
                            <input type="text" name="To" class="contactus" placeholder="Reciver Name">
                            </div>
                            <div class="col-md-6">
                            <input type="text" name="accountNo" class="contactus"placeholder="Reciver Account No">
                            </div>
                            <div class="col-md-6">
                            <input type="text" name="from" class="contactus"placeholder="Sender Name">
                            </div>
                            <div class="col-md-6">
                            <input type="text" name="accountnum" class="contactus"placeholder="Sender Account No">
                            </div>
                            <div class="col-md-6">
                            <input type="type" name="amount" class="contactus" placeholder="Amount">
                            </div>
                            <div class="col-md-12">
                                <button class="send_btn"type="submit" name="done">Send</button>
                            </div>
                        </div>
                    </form>
                </div>
