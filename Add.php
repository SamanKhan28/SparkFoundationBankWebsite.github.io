...
if (isset($_POST['done'])) {
    ...
    $amount = $_POST['amount'];
    $q = "INSERT INTO `customersinfo`(`CustomerName`, `CustomerEmail`, `Account_Number`, `Total_Amount`) VALUES ('$name','$email','$accountNo','$amount')";
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="row">
                 <div class="col-md-6 ">
                 <label>Name:</label>
                 <input type="text" name="name" class="contactus" placeholder="Customer Name">
                 </div>   
                 <div class="col-md-6 ">
                 <label>Email:</label>
                 ...
                 <input type="text" name="amount" class="contactus" placeholder="Amount">
                 </div>  
                 <div class="col-md-12">
