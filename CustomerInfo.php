        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <td>
                    ...
                    <td>
                        <?php echo $res['CustomerEmail']; ?>
                    </td>
                    <td>
                        <?php echo $res['Account_Number']; ?>
                    </td>
                    <td>
                 ...
                 <td> <button class="btn-primary btn">  <a href="Add.php"class="text-white">Add<button> </td>
